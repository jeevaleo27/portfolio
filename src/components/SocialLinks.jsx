...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jeeva-kaleeswar2710/",
    color: "#0A66C2",
  ...
  },
  {
   name: "Instagram",
    ...
    subText: "@_call_me_p_o_p_e_y_e__",
    icon: Instagram,
    url: "https://www.instagram.com/_call_me_p_o_p_e_y_e__/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@jeevaleo27",
    icon: Github,
    url: "https://github.com/jeevaleo27",
    color: "#ffffff",
